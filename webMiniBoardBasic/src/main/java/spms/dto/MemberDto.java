...
public class MemberDto implements BaseDto {
	...
	public MemberDto(int memberNo, String email, String password, String memberName) {
		super();
		this.memberNo = memberNo;
		this.email = email;
	...
	public String toString() {
		return "MemberDto [memberNo=" + memberNo + ", email=" + email + ", password=" + password + ", memberName="
				+ memberName + ", createdDate=" + createdDate + ", modifiedDate=" + modifiedDate + "]";
	}
