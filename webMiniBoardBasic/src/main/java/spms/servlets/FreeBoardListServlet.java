...
public class FreeBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ArrayList<FreeBoardDto> freeBoardList = (ArrayList<FreeBoardDto>) freeBoardDao.selectList();
			...
			RequestDispatcher dispatcher = req.getRequestDispatcher("/freeBoard/FreeBoardListView.jsp");
